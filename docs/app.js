...
var DateTime = function DateTime(_ref) {
  ...
  return {
    view: function view() {
      return event.startDate == event.endDate ? m(".", m("h3", m("label.strong", formatDate(event.startDate))), m("h4.grouped", m("label", formatTime(event.start)), m("label", " - "), m("label", formatTime(event.end)))) : m("h4.grouped", m("label.strong", formatDate(event.start)), m("label", " - "), m("label.strong", formatDate(event.end)));
    }
  };
};
...
;require.register("Components/marquee.js", function(exports, require, module) {
"use strict";
...
var Marq = {
  view: function view() {
    return m("marquee", {
      ...
      style: {
        background: "linear-gradient(to left top, white, lightgrey)"
      },
      direction: "down",
      width: "400px",
      height: "100px",
...
var scaleWidth = function scaleWidth(mdl) {
...
var Modal = {
  ...
  view: function view(_ref2) {
    ...
    return m("section.modal.".concat(mdl.modal.classList()), m(".modal-overlay", {
      "aria-label": "Close",
      onclick: function onclick(e) {
        return mdl.state.showLayoutModal(false);
      }
    }, m(".modal-container", m(".card.grid", {
      style: {
        position: "fixed",
        top: "5%",
        left: "10%",
        maxHeight: "90vh",
        overflow: "auto",
        width: "80%" // transform: `${scaleWidth(mdl)}`,
    ...
    }, m("header.modal-header.row", mdl.modal.header()), m(".modal-body", m(".", {
      style: {
        wordBreak: "break-word"
      }
    }, mdl.modal.content())), m(".modal-footer.row", mdl.modal.footer())))));
  }
};
var _default = Modal;
exports["default"] = _default;
...
var _excluded = ["mdl", "selector", "href", "link", "classList"];
...
var submitReport = function submitReport(mdl) {
  var onSuccess = function onSuccess(s) {};
  ...
  console.log("submit", state); // save imgBB then
  // mdl.http.back4App
  //   .postTask(mdl)("Classes/Reports")(state)
  //   .fork(onError, onSuccess)
};

var footer = function footer(mdl) {
  return m(".is-right grouped", m("button.button.primary", {
    onclick: function onclick(e) {
      e.preventDefault();
      submitReport(mdl);
    }
...
var form = m("form", m("formgroup.grouped", m("label", "Date", m("input", {
  type: "date",
  oninput: function oninput(e) {
...
var ViolationReport = function ViolationReport(mdl) {
...
var formatUIValue = function formatUIValue(val) {
  switch (val) {
    case typeof val == "boolean":
      return val ? m(_cjs.CheckLine) : m(_cjs.Times);
      break;
...
var Cell = function Cell() {
  return {
    view: function view(_ref) {
      ...
      return ["phone", "wide"].includes(screenSize) ? m("tr", [m("td", {
        style: {
          width: "25%"
        }
      }, m("label", children[0].key.toUpperCase())), m("th", children)]) : m("td", {
        style: {
          width: "20%"
        }
      }, children);
...
var Row = function Row(_ref2) {
  var _ref2$attrs = _ref2.attrs,
      mdl = _ref2$attrs.mdl,
      idxR = _ref2$attrs.idxR;
  return {
    view: function view(_ref3) {
      var row = _ref3.attrs.row;
      return [m("tr.card", {
        style: {
          borderBottom: "2px solid var(--color-lightGrey)"
        }
  ...
  return {
    view: function view(_ref4) {
      var _ref4$attrs = _ref4.attrs,
          mdl = _ref4$attrs.mdl,
          _ref4$attrs$data = _ref4$attrs.data,
          cols = _ref4$attrs$data.cols,
          rows = _ref4$attrs$data.rows;
      return m("section.table", {
        style: {
          minWidth: "100%",
          overflow: "auto"
        }
      }, rows.any() ? m("table.dash-table", !["phone", "wide"].includes(mdl.settings.screenSize) && m("thead.dash-nav", m("tr.mb-5", cols.map(function (col) {
        return m("th.primary", col.toUpperCase());
      }))), m("tbody", rows.map(function (row, idxR) {
        return m(Row, {
          mdl: mdl,
          row: row,
          idxR: idxR
...
var Footer = function Footer() {
  return {
    view: function view(_ref) {
      ...
      }))), m("p", "bonhamacrescivicassociation at gmail dot com"), m("p", "Bellaire, TX 77401")), m(".col-6", m("h3", "Useful Links"), m("ul.no-list", m("li", m("a.row.underline.nav-link", {
        target: "__blank",
        href: "https://www.bonhamacres.org/city-ordinances"
      }, "City of Houston City Ordinances")), m("li", m("a.row.underline.nav-link", {
        target: "__blank",
        href: "https://09ee40f4-9ff7-4e3d-819c-429f2403854d.filesusr.com/ugd/537320_f8abdef644b04cde8dc36f671bb9868f.pdf"
      }, "COH trash facts")), m("li", m("a.row.underline.nav-link", {
        target: "__blank",
        href: "https://www.houstontx.gov/solidwaste/Recycle_Cal.pdf"
      }, "COH recycling calendar Schedule B")), m("li", m("a.row.underline.nav-link", {
        target: "__blank",
        href: "https://mycity.maps.arcgis.com/apps/webappviewer/index.html?id=63ed96f439fe404387c9f9e479dc4965"
      }, "COH trash service day")), m("li", m("a.row.underline.nav-link", {
        target: "__blank",
        href: "http://www.houstontx.gov/solidwaste/treewaste.html"
      }, "COH tree and junk waste program")), m("li", m("a.row.underline.nav-link", {
        target: "__blank",
      ...
      }, "Streetlight outage repair")), m("li", m("a.row.underline.nav-link", {
        target: "__blank",
        href: "http://www.hcad.org/"
      }, "Harris County Appraisal District")), m("li", m("a.row.underline.nav-link", {
        target: "__blank",
        href: "http://www.hcfcd.org/"
      }, "Harris County Flood Control District")), m("li", m("a.row.underline.nav-link", {
        target: "__blank",
...
var _index = require("../Pages/Events/index.js");

var _editor = _interopRequireDefault(require("../Pages/Events/editor.js"));

var _event = _interopRequireDefault(require("../Pages/Events/event.js"));
...
var toEventViewModel = function toEventViewModel(event) {
  ...
  return {
    ...
    endDate: (0, _ramda.head)(end),
    endTime: (0, _ramda.tail)(end),
    title: event.title,
    allDay: event.allDay,
...
var fetchAll = function fetchAll(_ref3) {
  ...
  }).ap(fetchTask(mdl)("Classes/Events").map((0, _ramda.prop)("results")).map((0, _ramda.map)(toEventViewModel))).ap(fetchTask(mdl)("Classes/Gallery").map((0, _ramda.prop)("results")).map((0, _ramda.uniqWith)((0, _ramda.eqBy)((0, _ramda.prop)("thumb"))))).ap(fetchTask(mdl)("Classes/Blogs").map((0, _ramda.prop)("results"))).fork(onError, onSuccess);
};
...
var Layout = {
  ...
  view: function view(_ref5) {
    ...
    return m("#layout", {
      ...
      mdl: mdl
    }), mdl.state.showLayoutModal() && m(_modal["default"], {
      mdl: mdl
    }), _index.state.showEditor() && m(_editor["default"], {
      mdl: mdl,
      state: _index.state,
      showEditor: _index.state.showEditor,
      submitEvent: _index.submitEvent,
      deleteEvent: _index.deleteEvent,
      resetState: _index.resetState,
      uploadImage: (0, _index.uploadImage)(mdl)
    }), _index.state.previewEvent() && m(_event["default"], {
      mdl: mdl,
      state: _index.state,
      editEvent: _index.state.showEditor,
      previewEvent: _index.state.previewEvent,
      event: _index.state.event,
      resetState: _index.resetState
    }), m(_footer["default"], {
      mdl: mdl
    }));
...
var displayRoute = function displayRoute(mdl) {
  return function (r) {
...
var Model = {
  ...
  toggleLayoutModal: function toggleLayoutModal(mdl) {
    return mdl.state.showLayoutModal(!mdl.state.showLayoutModal());
  },
...
var Dues = {
  view: function view(_ref) {
    ...
    return m("section.p-y-50", m(_paypal["default"], {
      ...
      status: state,
      reload: reload
    }), mdl.data.dues.any() && m(_table.Table, {
      mdl: mdl,
      data: (0, _table.formatDataForTable)(["userId", "objectId", "createdAt", "updatedAt"], mdl.data.dues)
    }));
  }
};
var _default = Dues;
...
var Account = function Account(_ref) {
  ...
  return {
    ...
    view: function view(_ref4) {
      var mdl = _ref4.attrs.mdl;
      return m("section", state.status == "error" && m("ERROR"), state.status == "loading" && m("loading"), state.status == "success" && m("section", m("nav.nav.tabs", nav(mdl.user.role).map(function (tab) {
        return m(m.route.Link, {
...
;require.register("Pages/Account/map.js", function(exports, require, module) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports["default"] = exports.toPushPin = exports.setCenterView = exports.getCenterView = void 0;

var _data = _interopRequireDefault(require("data.task"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }

var getCenterView = function getCenterView(locations) {
  return Microsoft.Maps.LocationRect.fromLocations(locations);
};

exports.getCenterView = getCenterView;

var setCenterView = function setCenterView(state) {
  return function (bounds) {
    return state.map.setView({
      bounds: bounds,
      minZoom: 16
    });
  };
...
exports.setCenterView = setCenterView;

var toPushPin = function toPushPin(_ref) {
...
var loadMapConfig = function loadMapConfig(mdl) {
  return function (state) {
    var getCenterViewFromStateEntities = function getCenterViewFromStateEntities() {
      var locations = state.entities.any() ? state.entities.map(function (e) {
    ...
    var centerPoint = getCenterViewFromStateEntities();
    var lat = centerPoint.center.latitude;
    var lng = centerPoint.center.longitude;
...
var Map = function Map(_ref2) {
  var _ref2$attrs = _ref2.attrs,
      mdl = _ref2$attrs.mdl,
      locations = _ref2$attrs.locations;
  ...
  var go = function go(xs) {
    return AddResidentsTask(state, xs).map(loadMapConfig(mdl)).fork(onError, onSuccess);
  };
  ...
  return {
    ...
    view: function view(_ref3) {
      var _ref3$attrs = _ref3.attrs,
          mdl = _ref3$attrs.mdl,
          locations = _ref3$attrs.locations;
      return m("section", m("section#map", {
...
var Messages = {
  view: function view(_ref) {
    var mdl = _ref.attrs.mdl;
    return m(_table.Table, {
      mdl: mdl,
      data: (0, _table.formatDataForTable)([], mdl.data.messages)
    });
  }
};
...
var getAddressTask = function getAddressTask(mdl) {
  return function (id) {
    return mdl.http.back4App.getTask(mdl)("classes/Addresses/".concat(id));
  };
};

var getAddressesTask = function getAddressesTask(mdl) {
  return function (ids) {
    return ids.any() ? ids.traverse(getAddressTask(mdl), _data["default"].of) : _data["default"].of([]);
  };
};

var toProfileVM = function toProfileVM(_ref) {
  var _ref$user = _ref.user,
      emailVerified = _ref$user.emailVerified,
      email = _ref$user.email,
      name = _ref$user.name,
      _ref$data$account = _ref.data.account,
      objectId = _ref$data$account.objectId,
      avatar = _ref$data$account.avatar,
      address = _ref$data$account.address,
      telephone = _ref$data$account.telephone;
  return function (_ref2) {
    var addressIds = _ref2.addressIds;
    return {
      objectId: objectId,
      address: address,
...
var getProfileTask = function getProfileTask(mdl) {
  return function (id) {
    return mdl.http.back4App.getTask(mdl)("classes/Accounts?".concat(id)).map((0, _ramda.prop)("results")).map(_ramda.head).map(toProfileVM(mdl));
  };
};

var toDuesVM = function toDuesVM(_ref3) {
  var date = _ref3.date,
      ...
      email = _ref3.email;
  return date ? {
    date: (0, _helpers.formatDate)(date),
    status: status,
    name: full_name,
    email: email,
    address: address
  } : {
    date: (0, _helpers.formatDate)(createdAt),
...
var getDuesTask = function getDuesTask(mdl) {
  return function (id) {
...
var getMessagesTask = function getMessagesTask(mdl) {
  return function (id) {
...
var loadAllTask = function loadAllTask(mdl) {
  ...
  }).ap(getProfileTask(mdl)(id)).ap(getDuesTask(mdl)(id)).ap(getMessagesTask(mdl)(id)).ap(getAddressesTask(mdl)(mdl.data.account.addressIds));
};
...
var PayPal = function PayPal(_ref2) {
  ...
  var onError = function onError(mdl, state) {
    return function (error) {
      ...
      addError("There was an error with your payment. Please contact an administrator.");
    };
  ...
  var makePayment = function makePayment(actions) {
    makePaymentTask(actions) // .chain(logItem(mdl))
    .map(formatInvoice(mdl)).chain(saveInvoiceTask(mdl)).fork(onError(mdl, state), onSuccess(mdl, reload));
  };
  ...
  return {
    view: function view(_ref3) {
      ...
      return (0, _mithril.m)("section", state.paydues ? (0, _mithril.m)(".modal-container", (0, _mithril.m)(".modal", (0, _mithril.m)(".modal-header", (0, _mithril.m)("button.button", {
        onclick: togglePaypal
      }, "Cancel Payment")), (0, _mithril.m)(".modal-content", (0, _mithril.m)("#payment-request-button.is-center", {
        oncreate: function oncreate(_ref4) {
          var dom = _ref4.dom;
          paypal.Buttons({
            style: {
...
var fetchLocationsTask = function fetchLocationsTask(mdl) {
  return mdl.http.back4App.getTask(mdl)("classes/Addresses?limit=1000").map((0, _ramda.prop)("results"));
};

var toLocationVM = function toLocationVM(addressIds) {
  return function (locations) {
    return locations.map(function (location) {
      return (0, _ramda.assoc)("selected", addressIds.includes(location.objectId), location);
    });
  };
};

var fetchLocations = function fetchLocations(mdl) {
  return function (state) {
    var onError = log("error fetching locations");

    var onSuccess = function onSuccess(locations) {
      state.locations = locations;
    };

    fetchLocationsTask(mdl).map(toLocationVM(mdl.data.profile.addressIds)).fork(onError, onSuccess);
  };
};
...
var onSuccess = function onSuccess(mdl, reload) {
  (0, _toast.addSuccess)("Profile updated successfully", 5000);
  reload(mdl);
};
...
var updateModelAccount = function updateModelAccount(mdl, addressIds) {
  ...
  return function (_ref) {
    ...
    return function (reload) {
      return updateProfileTask(mdl)({
        ...
        return updateModelAccount(mdl, addressIds);
      }).fork(onError, function (_) {
        return onSuccess(mdl, reload);
      });
    };
  };
};
...
var uploadImage = function uploadImage(mdl) {
  return function (file) {
    ...
    }).fork(onError, function () {
      return (0, _toast.addSuccess)("Image Updated", 5000);
    });
  };
};
...
var addAddress = function addAddress(profile, addressId) {
  return profile.addressIds.push(addressId);
};

var removeAddress = function removeAddress(profile, addressId) {
  state.locations.find(function (l) {
    return l.objectId == addressId;
  }).selected = false;
  profile.addressIds = (0, _ramda.without)([addressId], profile.addressIds);
};

var toggleEditProfile = function toggleEditProfile(mdl, state, reload) {
        ...
        return (0, _mithril.m)("option", {
          onclick: function onclick(e) {
            ...
            state.addresses = state.addresses.filter(function (l) {
              return l.objectId == location.objectId;
            }).any() ? state.addresses : state.addresses.concat([location]);
            addAddress(mdl.data.profile, location.objectId);
          },
...
var tabs = ["blogs", "events", "images", "users", "dues"];
var state = {
  tab: "blogs"
};
...
var updateUserRole = function updateUserRole(mdl) {
  return function (id) {
    return function (role) {
      return function (name) {
        return mdl.http.back4App.putTask(mdl)("Users/".concat(id))({
          role: role
        }).fork(function () {
          return (0, _toast.addDanger)("Was unable to update ".concat(name, "'s role"));
        }, function () {
          (0, _toast.addSuccess)("".concat(name, "'s role was updated"));
          getData({
            attrs: {
              mdl: mdl
            }
...
var userViewmodel = function userViewmodel(_ref, mdl) {
  ...
  return {
    ...
    role: [m("select", {
      value: role,
      onchange: function onchange(e) {
        return updateUserRole(mdl)(objectId)(e.target.value)(name);
      }
    }, m("option", {
      value: "admin"
    }, "admin"), m("option", {
...
var duesViewModel = function duesViewModel(_ref5, mdl) {
  var date = _ref5.date,
      createdAt = _ref5.createdAt,
      status = _ref5.status,
      full_name = _ref5.full_name,
      email = _ref5.email,
  ...
  return date ? {
    ...
    date: (0, _helpers.formatDate)(createdAt),
    status: "ERROR - contact administrator",
    name: (0, _helpers.getUserByUserId)(userId, mdl).name,
    email: (0, _helpers.getUserByUserId)(userId, mdl).email,
    address: JSON.stringify(address)
  };
};
...
var handleType = function handleType(tab) {
  return function (mdl) {
    return function (data) {
      return displayType[tab](data, mdl);
    };
  };
};

var toViewmodel = function toViewmodel(state, mdl) {
  var data = mdl.data[state.tab].map(handleType(state.tab)(mdl));
  return (0, _table.formatDataForTable)(["username"], data);
};

var getUsersTask = function getUsersTask(mdl) {
  return mdl.http.back4App.getTask(mdl)("Users").map((0, _ramda.prop)("results")).map((0, _ramda.filter)((0, _ramda.prop)("name")));
};

var getDuesTask = function getDuesTask(mdl) {
  return mdl.http.back4App.getTask(mdl)("Classes/Dues").map((0, _ramda.prop)("results"));
};

var getData = function getData(_ref6) {
  var mdl = _ref6.attrs.mdl;

  _data["default"].of(function (users) {
    return function (dues) {
      return {
        users: users,
        dues: dues
  ...
  }).ap(getUsersTask(mdl)).ap(getDuesTask(mdl)).fork(log("error"), function (_ref7) {
...
var Admin = function Admin() {
  return {
    ...
    view: function view(_ref8) {
      ...
      return m("section", m("nav.nav.tabs", tabs.map(function (tab) {
      ...
      })), m("section.container", m(_table.Table, {
        mdl: mdl,
        data: toViewmodel(state, mdl)
      })));
    }
  };
};
...
exports.createMessagesTask = exports.createAccountTask = exports.registerUserTask = exports.resetPasswordTask = exports.loginTask = void 0;
...
var getAddressTask = function getAddressTask(mdl) {
  return function (addressId) {
    var login = encodeURI("objectId=".concat(addressId));
    return mdl.http.back4App.getTask(mdl)("classes/Addresses").map(log("address??"));
  };
};
...
var createAccountTask = function createAccountTask(mdl) {
  ...
  return mdl.http.back4App.postTask(mdl)("classes/Accounts")(mdl.user.account).map(function (_ref4) {
    var objectId = _ref4.objectId;
...
var createMessagesTask = function createMessagesTask(mdl) {
  ...
  return mdl.http.back4App.postTask(mdl)("classes/Conversations")(mdl.user.conversations).map(function (_ref5) {
...
var validateForm = function validateForm(mdl) {
  return function (data) {
    var onError = function onError(errs) {
      if (errs.code != 209) {
        var _state$errors, _state$errors$respons;

        state.errors = errs;
        state.msg((_state$errors = state.errors) === null || _state$errors === void 0 ? void 0 : (_state$errors$respons = _state$errors.response) === null || _state$errors$respons === void 0 ? void 0 : _state$errors$respons.error);
        state.showMsg(true);
      } else {
...
var Login = function Login() {
  return {
    ...
    view: function view(_ref2) {
      ...
      }), state.errors.password && m("p.text-error", state.errors.password)), m("button.button.primary.col-12", {
        role: "button",
        form: "login-form",
        onclick: function onclick() {
  ...
  return function (data) {
    var onError = function onError(errs) {
      if (errs) {
        ...
        state.errors = errs;
        state.errorMsg((_state$errors = state.errors) === null || _state$errors === void 0 ? void 0 : (_state$errors$respons = _state$errors.response) === null || _state$errors$respons === void 0 ? void 0 : _state$errors$respons.error);
    ...
    state.isSubmitted = true;
    (0, _Validations.validateUserRegistrationTask)(data).chain((0, _fns.registerUserTask)(mdl)).fork(onError, onSuccess);
  };
};
...
var Post = {
  view: function view(_ref) {
    ...
    return m("section.card", m(".row", m("hgroup.col", m("h2.bold", blog.title), m("h4", m("i", "Added On ", blog.createdAt, blog.updatedAt !== blog.createdAt && [" and updated on: ", blog.updatedAt], " by ", blog.author))), m("figure.col-3.is-horizontal-align", m("img", {
      ...
      onclick: function onclick(e) {
        mdl.modal.content(m("img.is-center", {
          style: {
            height: "100%",
            margin: "0 auto"
          },
...
var BackToBlogs = function BackToBlogs() {
  return m(m.route.Link, {
...
var BlogPost = {
  ...
  view: function view(_ref5) {
    var mdl = _ref5.attrs.mdl;
    return m("section.fade.p-y-6.container", state.status == "error" && m("p", "error redirecting"), state.status == "loading" && m(_loader["default"]), state.status == "loaded" && [BackToBlogs(), m(Post, {
      blog: state.blog,
      mdl: mdl
    }), BackToBlogs() // m(Comments, { blog: state.blog, comments: state.comments, mdl }),
    ]);
  }
};
...
var deleteBlog = function deleteBlog(mdl) {
  return function (_ref3) {
    ...
    return (0, _Utils.confirmTask)("Are you sure you want to delete the blog ".concat(title, "?")).chain(function (_) {
      return imageId ? mdl.http.back4App.deleteTask(mdl)("Classes/Gallery/".concat(imageId)) : _data["default"].of();
    }).chain(function (_) {
      return mdl.http.back4App.deleteTask(mdl)("Classes/Blogs/".concat(objectId));
    }).fork(function (e) {
      console.log(e);
    }, toBlogs);
  };
...
;require.register("Pages/BonhamAcresMap/index.js", function(exports, require, module) {
"use strict";
...
var load = function load(mdl, state) {
  return (0, _model.loadResidentsTask)(mdl, state).map((0, _model.loadMapConfig)(mdl));
};
...
var restartFindResident = function restartFindResident(mdl, state) {
  load(mdl, state).fork(log("e"), function () {
...
var saveResident = function saveResident(mdl, state) {
  ...
  (0, _model.saveResidentTask)(mdl, state.newLocation).chain(function () {
    return load(mdl, state);
  }).fork(onError, onSuccess);
};
...
var _default = BonhamAcresMap;
exports["default"] = _default;
});

;require.register("Pages/BonhamAcresMap/model.js", function(exports, require, module) {
"use strict";
...
var defaultPushPinEntities = function defaultPushPinEntities(mdl) {
  return [toPushPin({
    property: "BACA",
    lat: Microsoft.Maps.Location.parseLatLong(mdl.Map.bh).latitude,
    lng: Microsoft.Maps.Location.parseLatLong(mdl.Map.bh).longitude
...
exports.defaultPushPinEntities = defaultPushPinEntities;
...
var loadMapConfig = function loadMapConfig(mdl) {
  return function (state) {
    var getCenterViewFromStateEntities = function getCenterViewFromStateEntities() {
      var locations = state.entities.map(function (e) {
        return e.getLocation();
      });
      return getCenterView(locations);
    };
    ...
    var lat = centerPoint.center.latitude;
    var lng = centerPoint.center.longitude;
    state.opts.center = new Microsoft.Maps.Location(lat, lng); // make map
...
exports.loadMapConfig = loadMapConfig;

var toPin = function toPin(lat, lng, opts) {
  return new Microsoft.Maps.Pushpin({
    altitude: 0,
    altitudeReference: -1,
    latitude: lat,
...
var toPushPin = function toPushPin(_ref, opts) {
  var property = _ref.property,
      lat = _ref.lat,
      lng = _ref.lng;
  return (0, _ramda.compose)(addMetaData(property), toPin)(lat, lng, opts);
};

exports.toPushPin = toPushPin;

var updateStateEntities = function updateStateEntities(state) {
...
var findLocationTask = function findLocationTask(mdl, query) {
  return mdl.http.openCage.getLocationTask(mdl)(query).map((0, _ramda.path)(["results"]));
...
var onEventClick = function onEventClick(mdl, state) {
...
var initCal = function initCal(mdl, dom, state, events) {
...
var Event = {
  view: function view(_ref) {
    ...
    }).join(", ")), event.location && m("h4.grouped", m(_cjs.HomeSolid, {
      fill: "#14854f",
      height: 35,
      width: 35
...
exports["default"] = exports.submitEvent = exports.uploadImage = exports.deleteEvent = exports.resetState = exports.state = void 0;
...
var Events = {
  ...
  view: function view(_ref4) {
    var mdl = _ref4.attrs.mdl;
    return m("article", state.status() == "loaded" && m("section.container", m(_calendar["default"], {
      mdl: mdl,
      state: state
...
var startDateLens = (0, _ramda.lensProp)("start");
...
var deleteAlbum = function deleteAlbum(mdl) {
  ...
  (0, _Utils.confirmTask)("Are you sure you want to delete Album ".concat(state.title, "?")).chain(function (_) {
    return (0, _ramda.traverse)(_data["default"].of, deleteImageTask(mdl), state.album);
  }).fork(onError, onSuccess);
};

var deleteImg = function deleteImg(mdl, pic) {
  log("wtf")(pic); // console.log(pic)
  ...
  (0, _Utils.confirmTask)("Are you sure you want to delete this Image?").chain(function (_) {
    return deleteImageTask(mdl)(pic);
  }).fork(onError, onSuccess);
};
...
var fetchAlbum = function fetchAlbum(_ref2) {
  ...
  mdl.http.back4App.getTask(mdl)("Classes/Gallery?".concat(byAlbumName)).map((0, _ramda.prop)("results")).map(_ramda.reverse).map((0, _ramda.uniqWith)((0, _ramda.eqBy)((0, _ramda.prop)("thumb")))).fork(onError, onSuccess);
};

var saveImgToGalleryTask = function saveImgToGalleryTask(mdl) {
  return function (_ref3) {
    var _ref3$data = _ref3.data,
        image = _ref3$data.image,
        thumb = _ref3$data.thumb;
    return mdl.http.back4App.postTask(mdl)("Classes/Gallery")({
      album: state.title,
      image: image.url,
      thumb: thumb.url
...
var AddImagesModal = function AddImagesModal() {
  return {
    onremove: function onremove() {
    ...
    view: function view(_ref4) {
      ...
      return m("section.modal-container", m("article.modal.card.grid", m("header.modal-header", m("h2", "Drag and drop or add using the button")), m("section.modal-content", state.isUpLoading() ? m("p", "PROCESSING IMAGES... PLEASE BE PATIENT") : m("form.grid", m("input", {
        ...
        id: "files",
        multiple: true
      }), m(".row", state.modalState.previewImgs.map(function (_ref5) {
        var src = _ref5.src,
            file = _ref5.file;
        ...
        onclick: function onclick() {
          return state.addImagesModal(false);
        }
      }, "Cancel"), m("button", {
        onclick: function onclick(e) {
...
var Album = {
  ...
  view: function view(_ref6) {
    ...
    return mdl.state.isLoading() && !state.isUpLoading() ? m(_loader["default"]) : m("article.grid.p-y-6.fade.", m("nav.grouped.m-y-6", m(m.route.Link, {
      ...
      onclick: function onclick(e) {
        return state.addImagesModal(true);
      }
    }, "Add more Images to Album"), m("button.button error", {
      onclick: function onclick(e) {
        deleteAlbum(mdl);
      }
    }, "Delete Album")], state.addImagesModal() && m(AddImagesModal, {
      mdl: mdl
    })), m("section.container", m("h2", state.title.toLocaleUpperCase()), m(".row", state.album.map(function (pic, idx) {
...
var groupByAlbum = (0, _ramda.groupBy)((0, _ramda.prop)("album"));
var sortByUpdatedAlbum = (0, _ramda.sortWith)([(0, _ramda.descend)((0, _ramda.prop)("updatedAt")), (0, _ramda.ascend)((0, _ramda.prop)("album"))]);
var groupByAlbumAndDate = (0, _ramda.compose)(groupByAlbum, sortByUpdatedAlbum);
...
var fetchAllAlbums = function fetchAllAlbums(_ref) {
  ...
  mdl.http.back4App.getTask(mdl)("Classes/Gallery").map((0, _ramda.prop)("results")).map(groupByAlbumAndDate).fork(onError, onSuccess);
};
...
var createNewAlbum = function createNewAlbum(mdl) {
  var onError = function onError(e) {
    return log("createNewAlbum- error")(e);
  };
...
var Gallery = {
  ...
  view: function view(_ref5) {
    var mdl = _ref5.attrs.mdl;
    return mdl.state.isLoading() ? m(_loader["default"]) : m("article.fade", mdl.state.isAuth() && m("nav.nav", m(".nav-center", m("button.button.primary", {
      onclick: function onclick(e) {
      ...
      mdl: mdl
    }))), m(".row.container-fluid", Object.keys(state.albums).map(function (album) {
      return m(AlbumCover, {
        mdl: mdl,
...
;require.register("Pages/board-members.js", function(exports, require, module) {
"use strict";
...
var BoardMembers = function BoardMembers(mdl) {
  return {
    view: function view(_ref) {
      var mdl = _ref.attrs.mdl;
      return m("article", m("section.container", m("h2.is-center.is-marginless.m-b-15.strong", "2022-2023 Bonham Acres Civic Association Board Members"), m(".row", current.map(function (_ref2) {
        var title = _ref2.title,
            name = _ref2.name;
        return m(".card.col-".concat(calcSize(mdl)), m("h4.text-primary", title), m("p", name));
      })), m("row.container", m("a.button", {
        target: "__blank",
        name: "gmail",
        href: "http://mailto:bonhamacrescivicassociation@gmail.com/"
      }, m("h3", "Click here to send us an email!"))), m("section.container", m("h3.primary-text", "Past Board Members"), m("ul", past.map(function (member) {
        return m("li", "".concat(member.title, " ").concat(member.name));
      })))));
    }
  };
};

var _default = BoardMembers;
exports["default"] = _default;
});
...
var contents = {
  car: {
    ...
    contents: m("", // ".container",
    // {
    //   style: { maxHeight: "50vh", overflow: "auto", wordBreak: "break-word" },
    // },
    m("em", "Parking of Vehicles on Residential Property Chapter 28, Article X"), m("p", "To read the complete ordinance, go to ", m("a.nav-link", {
      target: "__blank",
  ...
  noise: {
    ...
    //   style: { maxHeight: "50vh", overflow: "auto", wordBreak: "break-word" },
    // },
    m("p", "According to the ", ("a.nav-link", {
      target: "__blank",
      href: "#"
    ...
    view: function view(_ref3) {
      ...
      return m("article.card.col-6.bd-primary.p-x-50.p-y-6.pointer", {
        ...
        onclick: function onclick() {
          ...
          mdl.toggleLayoutModal(mdl); // state.showModal(true)
        }
...
var CityOrd = {
  view: function view(_ref4) {
    ...
    return m("section.container", {
      ...
      disabled: true,
      onclick: function onclick(e) {
        return (0, _report["default"])(mdl);
      } // state.showOrdinanceViolation(true)

    }, "COMING SOON Report City Ordinance Violation", m(_clarity.ExclamationTriangleLine, {
      fill: "red"
    })) : m(m.route.Link, {
      selector: "button",
      "class": "button.bd-error",
      href: "/login"
    }, "Login To Report City Ordinance Violation") // state.showOrdinanceViolation() &&
    //   m(ViolationReport, {
    //     mdl,
...
var DeedRes = function DeedRes(_ref) {
  ...
  return {
    view: function view() {
      return m("section", m("a.button.grouped.isLeft.icon", {
        target: "_blank",
        href: "https://drive.google.com/drive/folders/17H-Zq2BBN8yKp19c4BQGIYvMPIqhgYL-"
      }, "View All Bonham Acres files", m(_cjs.PopOutLine, {
        margin: "8px",
        width: "15px",
        height: "15px"
      })), m("nav.tabs", Object.keys(pages).map(function (tab) {
        return m(m.route.Link, {
...
var tomorrow = (0, _dayjs["default"])().add(-1, "day");

var eventIsUpcoming = function eventIsUpcoming(evt) {
  return (0, _dayjs["default"])(evt.startDate).isAfter(tomorrow);
};
...
var Blog = {
  view: function view(_ref) {
    ...
    }, m(".card.opacity-overlay.is-vertical-align m6 row", {}, m("img", {
      src: blog.img || "images/main.webp",
      alt: "",
      style: {
        objectFit: "contain",
...
var Event = {
  view: function view(_ref3) {
    ...
    }, m(".card.is-vertical-align m6 row", {}, event.allDay && m("p.tag", "All Day Event!"), m(".row.grouped", m("h2.is-left.text-primary text-wrap", event.title), m("img.is-right", {
      alt: "",
      style: {
        maxHeight: "100px"
      },
...
var Home = {
  ...
  view: function view(_ref8) {
    var mdl = _ref8.attrs.mdl;
    return m("#home-page.container-fluid", m("article.grid", m(Section, {
      mdl: mdl,
...
var _boardMembers = _interopRequireDefault(require("Pages/board-members.js"));
...
var _index3 = _interopRequireDefault(require("Pages/BonhamAcresMap/index.js"));
...
var getUserByUserId = function getUserByUserId(userId, mdl) {
  return mdl.data.users.find(function (u) {
    return u.objectId == userId;
  });
};

exports.getUserByUserId = getUserByUserId;

var confirmTask = function confirmTask(msg) {
  return new _data["default"](function (rej, res) {
    return window.confirm(msg) ? res() : rej();
  });
};
...
var cachCall = function cachCall(url) {
  return url == "users/me" ? {
...
var back4App = {
  getTask: function getTask(mdl) {
    return function (url) {
      return HttpTask(_secrets.BACK4APP.headers(mdl, _secrets.BACK4APP, cachCall(url)))("GET")(mdl)("".concat(_secrets.BACK4APP.baseUrl, "/").concat(url))(null);
    };
  },
  postTask: function postTask(mdl) {
    return function (url) {
...
var imgBB = {
  postTask: function postTask(mdl) {
    return function (file) {
      ...
      image.set("key", _secrets.IMGBB.apiKey); // console.log(image, file)
...
var openCage = {
  getLocationTask: function getLocationTask(mdl) {
    return function (query) {
      return HttpTask(_secrets.OpenCage.headers())("GET")(mdl)(OpenCageUrl + query + "&pretty=1&countrycode=us&bounds=".concat(encodeURIComponent(mdl.Map.bounds())))(null);
    };
  }
};
var http = {
...
var getWinSize = function getWinSize(w) {
...
var checkWidth = function checkWidth(winW) {
  ...
  if (winW !== w) {
    ...
    _index["default"].settings.screenSize = getWinSize(w);
...
_index["default"].settings.screenSize = getWinSize(winW);
checkWidth(winW);

if (sessionStorage.getItem("baca-session-token")) {
  var getUserTask = function getUserTask(mdl) {
    return _index["default"].http.back4App.getTask(_index["default"])("users/me");
  };

  var getUserAccountTask = function getUserAccountTask(mdl) {
    return function (user) {
      var encodeId = encodeURI("where={\"userId\":\"".concat(mdl.user.objectId, "\"}"));
      return mdl.http.back4App.getTask(mdl)("classes/Accounts?".concat(encodeId)).map((0, _ramda.prop)("results")).map(_ramda.head);
    };
  };

  var updateModelWithUser = function updateModelWithUser(mdl) {
    return function (user) {
      mdl.user = user;
  ...
  var updateModelWithAccount = function updateModelWithAccount(mdl) {
  ...
  var reloginTask = function reloginTask(mdl) {
    return getUserTask(mdl).map(updateModelWithUser(mdl)).chain(getUserAccountTask(mdl)).map(updateModelWithAccount(mdl));
  };
  ...
  reloginTask(_index["default"]).fork(onError, onSuccess);
}

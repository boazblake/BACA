...
var NavSection = function NavSection(_ref2) {
  ...
  return {
    view: function view(_ref3) {
      ...
      })), isSelected() ? childRoutes.map(function (r) {
        return m(".", r.group.includes("external") ? m("a.p-8", {
          target: "_blank",
          href: r.external
        }, r.name) : m(NavItem, {
          mdl: mdl,
  ...
  return {
    view: function view(_ref) {
      ...
      return m(".navbar.grid", mdl.settings.screenSize !== "desktop" ? m(".col", {
        ...
        mdl: mdl
      })) : m(".col", "Members"), m(".col.col-grow-2", "LOGO"), m(".col", "Safety"));
    }
  };
};
  ...
  return {
    ...
    view: function view(_ref) {
      ...
      return mdl.state.isLoading() ? (0, _mithril["default"])(_LogoLoader["default"], {
        mdl: mdl
      }) : (0, _mithril["default"])(".grid", [state.showErrorMsg() && (0, _mithril["default"])("code.warning", state.errorMsg()), (0, _mithril["default"])("form.grid", {
        role: "form",
        id: "login-form",
        onsubmit: function onsubmit(e) {
          return e.preventDefault();
        }
      }, (0, _mithril["default"])(".col", (0, _mithril["default"])("input.auth-input", {
      ...
      }), state.errors.email && (0, _mithril["default"])("p.auth-input-hint", state.errors.email)), (0, _mithril["default"])(".col", (0, _mithril["default"])("input.auth-input", {
...
var MemberRoutes = [{
  ...
  children: [],
  options: [] //   onmatch: (mdl, args, path, fullroute, isAnchor) => {
  //     isAnchor

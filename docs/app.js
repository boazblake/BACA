  ...
  return {
    view: function view(_ref) {
      ...
      return m("footer.footer.grid.card", m("section.row", m(".col-6", m("h2", "Connect with Bonham Acres via"), m(".container.grouped", m("a.row.underline.nav-link", {
        ...
        src: "icons/gmail.png"
      }))), m("p", "bonhamacrescivicassociation at gmail dot com"), m("p", "P O Box 2886"), m("p", "Bellaire, TX 77401")), m(".col-6", m("h3", "Useful Links"), m("ul", m("li", m("a.row.underline.nav-link", {
        target: "__blank",
...
var _default = {
  view: function view(_ref) {
    ...
    return m("main", m("#page-title.is-marginless.bg-primary.text-white.is-vertical-align.is-horizontal-align.is-center", m("p.text-center.p-t-25", mdl.state.route.name || "\n        ")), children);
  }
};
exports["default"] = _default;
});
...
var PayPal = function PayPal(_ref2) {
  ...
  var logItem = function logItem(mdl) {
    return function (data) {
      return mdl.http.back4App.postTask(mdl)("classes/Logging")({
  ...
  var makePayment = function makePayment(actions) {
    makePaymentTask(actions).chain(logItem(mdl, state)).map(formatInvoice(mdl)).chain(saveInvoiceTask(mdl)).fork(onError(mdl, state), onSuccess(mdl, reload));
  };
...
var duesViewModel = function duesViewModel(_ref5) {
  var date = _ref5.date,
  ...
  if ("serviceWorker" in navigator) {
    window.addEventListener("load", function () {
      navigator.serviceWorker.register("./sw.js").then(function (registration) {
        console.log("⚙️ SW registered: ", registration); // Notification.requestPermission(function (result) {
        //   if (result === "granted") {

...
var CityOrd = function CityOrd(mdl) {
  return {
    view: function view(_ref3) {
      ...
      }, "Report City Ordinance Violation", m(_cjs.ExclamationTriangleLine, {
        fill: "red"
      })) : m(m.route.Link, {
        selector: "button",

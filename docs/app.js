...
var Modal = {
  view: function view(_ref) {
    ...
    }, m(".modal-container", m("header.modal-header", mdl.modal.header()), m(".modal-body", m(".content", mdl.modal.content())), m(".modal-footer", mdl.modal.footer())))]);
  }
};
var _default = Modal;
exports["default"] = _default;
...
var Modal = {
  view: function view() {
    ...
    }, m(".modal", m("header.modal-header"), m("section.modal-content.flex-col", {
      onclick: function onclick(e) {
...
var BlogPost = {
  ...
  view: function view(_ref5) {
    ...
    return m("section.fade.p-y-6.container", state.status == "error" && m("p", "error redirecting"), state.status == "loading" && m(_loader["default"]), state.status == "loaded" && [BackToBlogs(), m(Post, {
      blog: state.blog,
      mdl: mdl
    }), BackToBlogs(), state.modal() && m(Modal) // m(Comments, { blog: state.blog, comments: state.comments, mdl }),
    ]);
  }
};
  ...
  view: function view(_ref7) {
    ...
    return mdl.state.isLoading() && !state.isUpLoading() ? m(_loader["default"]) : m("article.grid.p-y-6.fade.", m("nav.grouped.m-y-6", m(m.route.Link, {
      ...
      return m("figure.is-center.col-4.pos-rel", mdl.state.isAuth() && m(_cjs.TimesCircleLine, {
        ...
        src: pic.thumb,
        onclick: function onclick(e) {
          return state.showSelectedImage(pic.image);
        }
      }));
    })), state.showSelectedImage() && m(".modal-container", {
      style: {
        minHeight: "100vh"
      }
    }, m(".modal", m("header.modal-header"), m("section.modal-content.flex-col", {
      onclick: function onclick(e) {
        return state.showSelectedImage(null);
      }
    }, m("img", {
      alt: "",
...
var groupByAlbum = (0, _ramda.compose)((0, _ramda.groupBy)((0, _ramda.prop)("album")), (0, _ramda.sortWith)([(0, _ramda.descend)((0, _ramda.prop)("updatedAt")), (0, _ramda.ascend)((0, _ramda.prop)("album"))]), (0, _ramda.prop)("results"));

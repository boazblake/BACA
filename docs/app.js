...
var Footer = function Footer() {
  return {
    view: function view(_ref) {
      ...
      }))), m("p", "bonhamacrescivicassociation at gmail dot com"), m("p", "P O Box 2886"), m("p", "Bellaire, TX 77401")), m(".col-6", m("h3", "Useful Links"), m("ul.no-list", m("li", m("a.row.underline.nav-link", {
        target: "__blank",
...
var _default = {
  view: function view(_ref) {
    ...
    return m("main", m("#page-title.is-marginless.bg-primary.text-white.is-vertical-align.is-horizontal-align.is-center", m("p.text-center.p-t-25", {
      style: {
...
exports.createMessagesTask = exports.createDuesTask = exports.createAccountTask = exports.registerUserTask = exports.resetPasswordTask = exports.loginTask = void 0;
...
var createDuesTask = function createDuesTask(mdl) {
  ...
  return mdl.http.back4App.postTask(mdl)("classes/Dues")(mdl.user.dues).map(function (_ref5) {
...
var createMessagesTask = function createMessagesTask(mdl) {
  ...
  return mdl.http.back4App.postTask(mdl)("classes/Conversations")(mdl.user.conversations).map(function (_ref6) {
...
var BoardMembers = function BoardMembers(mdl) {
  return {
    view: function view(_ref) {
      var mdl = _ref.attrs.mdl;
      return (0, _mithril.m)("article", (0, _mithril.m)("section.container", (0, _mithril.m)("h2.is-center.is-marginless.m-b-15.strong", "2022-2023 Bonham Acres Civic Association Board Members"), (0, _mithril.m)(".row.container", current.map(function (_ref2) {
        var title = _ref2.title,
            name = _ref2.name;
        return (0, _mithril.m)(".card.col-".concat(calcSize(mdl)), (0, _mithril.m)("h4.text-primary", title), (0, _mithril.m)("p", name));
      })), (0, _mithril.m)("row.container", (0, _mithril.m)("a.button", {
        target: "__blank",
        name: "gmail",
        href: "http://mailto:bonhamacrescivicassociation@gmail.com/"
      }, (0, _mithril.m)("h3", "Click here to send us an email!"))), (0, _mithril.m)("section.container", (0, _mithril.m)("h3.primary-text", "Past Board Members"), (0, _mithril.m)("ul", past.map(function (member) {
        return (0, _mithril.m)("li", "".concat(member.title, " ").concat(member.name));
      })))));
    }
  };
};
...
var Home = {
  ...
  view: function view(_ref8) {
    var mdl = _ref8.attrs.mdl;
    return m("#home-page", state.image() ? m(".modal-container", {
      style: {
        minHeight: "100vh"
      }
    }, m(".modal", m("header.modal-header"), m("section.modal-content.flex-col", {

  ...
  return {
    view: function view(_ref3) {
      ...
      return m("section.bd-light", {
        "class": mdl.settings.screenSize == "desktop" && "p-50"
      }, m("section.card.is-marginless", m("p", "Bonham Acres is a deed restricted community in which deed restrictions are actively enforced. ", m(m.route.Link, {
...
var Section = {
  view: function view(_ref5) {
    ...
    return m("section.row.p-b-25.bg-light", data.any() && m(".glider-contain", {

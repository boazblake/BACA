...
var Main = function Main() {
  return {
    view: function view(_ref) {
      ...
      return m("main", m("section#page-title.is-marginless.bg-primary.text-white.is-vertical-align.is-horizontal-align.is-center", m("h1.text-center.p-t-25.heading", mdl.state.route.name)), children);
    }
  };
};
...
var Comments = {
  view: function view(_ref2) {
    var _ref2$attrs = _ref2.attrs,
        blog = _ref2$attrs.blog,
        comments = _ref2$attrs.comments,
        mdl = _ref2$attrs.mdl;
    return m("section.container.p-y-25", m("aside.card", m(".row", m("figure.col-2.is-left", m("img.avatar", {
      style: {
        maxWidth: "100px"
      },
      src: mdl.user.avatar || _Utils.AVATAR_URL
    })), m(".col-10.is-right", m("textarea.w100", {
      rows: 3,
      onchange: function onchange(e) {
        return state["new"].comment = e.target.value;
      }
    }, state["new"].comment))), m("footer.is-right", m("button.is-right", "Submit"))), comments && comments.map(function (comment) {
      return m("aside.row.card", m("figure.col", m("img.avatar", {
        style: {
          maxWidth: "100px"
        },
        src: mdl.user.avatar || _Utils.AVATAR_URL
      }), m("label.row", "comment.user"), m("label.row", "comment.date")), m("p.col", comment));
    }));
  }
};
...
var fetchBlogPost = function fetchBlogPost(_ref3) {
  var mdl = _ref3.attrs.mdl;
...
var BlogPost = {
  ...
  view: function view(_ref6) {
    var mdl = _ref6.attrs.mdl;
    return mdl.state.isLoading() ? m(_loader["default"]) : m("section.fade.p-y-6.container", m(Post, {
      blog: state.blog,
      mdl: mdl
    }), m(Comments, {
      blog: state.blog,
...
console.log(_htmlSanitize["default"]);
var BlogPreview = {
  view: function view(_ref) {
    var _ref$attrs = _ref.attrs,
        mdl = _ref$attrs.mdl,
...
var Nav = {
  view: function view() {
    return m("nav.p-t-25.row", m("button.button.nav-left.outline.dark", m(_cjs.AngleDoubleLine, {
      style: {
        transform: "rotate(270deg)"
      }
    })), m("button.button.nav-right.outline.dark", m(_cjs.AngleDoubleLine, {
      style: {

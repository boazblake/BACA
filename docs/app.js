...
var DateTime = function DateTime(_ref) {
  ...
  var formatDate = function formatDate(x) {
    return (0, _moment["default"])(x).format("dddd, MMMM Do YYYY");
  };

  var formatTime = function formatTime(x) {
    return (0, _moment["default"])(x).format("h:mm a");
  };

  return {
    view: function view() {
      return event.startDate == event.endDate ? m(".", m("p", m("label.strong", formatDate(event.startDate))), m("p.grouped", m("label", formatTime(event.start)), m("label", " - "), m("label", formatTime(event.end)))) : m(".", m("p", m("label.strong", formatDate(event.startDate)), m("label", " - "), m("label.strong", formatDate(event.endDate))));
    }
  };
};
...
var Editor = {
  view: function view(_ref) {
    ...
    return (0, _mithril.m)("aside.modal-container", (0, _mithril.m)("article.modal", (0, _mithril.m)("section.modal-content.container", (0, _mithril.m)("form.grid", _objectSpread({}, onInput(state.event)), (0, _mithril.m)("formgroup.grouped", (0, _mithril.m)("label", "Start Date", (0, _mithril.m)("input", {
      type: "date",
      id: "startDate",
      value: state.event.startDate
    })), (0, _mithril.m)("label", "Start Time", (0, _mithril.m)("input", {
      type: "time",
      id: "startTime",
      value: state.event.startTime,
      pattern: "(?:[01]|2(?![5-9])){1}d{1}:[0-5]{1}d{1}"
    }))), (0, _mithril.m)("formgroup", (0, _mithril.m)("label", "All Day Event?", (0, _mithril.m)("input", {
      type: "checkbox",
      id: "allDay",
      value: state.event.allDay,
      checked: state.event.allDay
    }))), (0, _mithril.m)("formgroup.grouped", (0, _mithril.m)("label", "End Date", (0, _mithril.m)("input", {
      type: "date",
      id: "endDate",
      value: state.event.endDate
    })), (0, _mithril.m)("label", "End Time", (0, _mithril.m)("input", {
      type: "time",
      id: "endTime",
      value: state.event.endTime
    }))), (0, _mithril.m)("formgroup", (0, _mithril.m)("label", "Title", (0, _mithril.m)("input", {
      type: "text",
      id: "title",
      value: state.event.title
    }))), state.status() == "uploading-image" ? (0, _mithril.m)("h2.tag.is-center", "Attaching Image - please be patient") : (0, _mithril.m)("formgroup.grouped", (0, _mithril.m)("label", "Upload an Image", (0, _mithril.m)("input", {
      type: "file",
      id: "file",
      value: state.files,
    ...
    }), state.event.image && (0, _mithril.m)("img", {
      src: state.event.image
    }))), (0, _mithril.m)("label.icon", "Location", (0, _mithril.m)("input", {
      oninput: function oninput(e) {
    ...
    })), data.locations.any() && (0, _mithril.m)("details.dropdown", (0, _mithril.m)("summary.button.outline", "options"), (0, _mithril.m)(".card", (0, _mithril.m)("ul", data.locations.map(function (_ref3) {
      var formatted = _ref3.formatted;
      return (0, _mithril.m)("li.pointer", {
        onclick: function onclick(e) {
          return state.event.location = formatted;
        }
      }, formatted);
    })))), (0, _mithril.m)("formgroup", (0, _mithril.m)("label", "Description", (0, _mithril.m)("textarea", {
      id: "description",
      value: state.event.description
    }))))), (0, _mithril.m)("footer.modal-footer", (0, _mithril.m)(".tabs.grouped.is-center", (0, _mithril.m)("button.button", {
      onclick: function onclick() {
        resetState(state);
        showEditor(false);
      }
    }, "Cancel"), state.event.id && (0, _mithril.m)("button.button.error", {
      onclick: function onclick(e) {
        deleteEvent(mdl, state.event.id);
      },
      role: "button"
    }, "Delete"), (0, _mithril.m)("button.button.primary", {
      onclick: function onclick(e) {
...
var Event = {
  view: function view(_ref) {
    var _ref$attrs = _ref.attrs,
        ...
        resetState = _ref$attrs.resetState,
        state = _ref$attrs.state;
    return (0, _mithril["default"])(".modal-container", (0, _mithril["default"])(".modal", (0, _mithril["default"])("header.modal-header", (0, _mithril["default"])("h2.text-primary", event.title.toUpperCase()), event.allDay && (0, _mithril["default"])(".grouped", (0, _mithril["default"])("label.tag.primary", "All Day Event")), (0, _mithril["default"])(".grouped", (0, _mithril["default"])(_clarity.CalendarLine, {
      fill: "#14854f",
      height: 30,
      width: 30
    }), (0, _mithril["default"])(_DateTime["default"], {
      event: event
    })), event.location && (0, _mithril["default"])(".grouped", (0, _mithril["default"])(_clarity.HomeSolid, {
      fill: "#14854f",
      height: 30,
      width: 30
    }), event.location), (0, _mithril["default"])(".grouped", (0, _mithril["default"])("img", {
      src: event.image
    }))), (0, _mithril["default"])("section.modal-content container card", (0, _mithril["default"])(".grouped", (0, _mithril["default"])("label", event.description))), (0, _mithril["default"])("footer.modal-footer", (0, _mithril["default"])(".tabs grouped", (event.createdBy == mdl.user.name || ["admin", "mod"].includes(mdl.user.role)) && (0, _mithril["default"])("button.button.secondary.is-full-width", {
      onclick: function onclick(e) {
        editEvent(true);
        previewEvent(false);
        e.preventDefault();
      ...
      role: "button",
      disabled: false
    }, "Edit"), (0, _mithril["default"])("button.button.primary.is-full-width", {
      onclick: function onclick() {
        resetState(state);

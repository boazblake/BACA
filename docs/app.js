...
var onBodyScroll = function onBodyScroll(e) {
  return state.distanceFromTop = e.target.scrollTop;
};
...
var onLayout = function onLayout(mdl) {
  return function (_ref) {
    var dom = _ref.dom;
    log("mdl")(mdl);
    mdl.settings.screenSize == "desktop" && dom.parentNode.addEventListener("scroll", onBodyScroll);
  };
};

  ...
  return {
    view: function view(_ref2) {
      ...
      return m("section.p-y-50", m("article.row", _objectSpread({}, onInput(data)), m("figure.col", m("img.avatar", {
        src: data.avatar ? data.avatar : AVATAR_URL
      }), m("figcaption", {
        style: {
          width: "180px"
        }
        ...
        oninput: function oninput(e) {
          if (e.target.value.length > 3) {
            ...
            mdl.http.openCage.getLocationTask(mdl)(e.target.value.trim()).fork(function (e) {
              state.status = "error";
              (0, _Utils.log)("error fetching locations")(e);
            }, function (_ref3) {
...
var Event = {
  view: function view(_ref) {
    var _ref$attrs = _ref.attrs,
        ...
        resetState = _ref$attrs.resetState,
        state = _ref$attrs.state;
    return m(".modal-container", m(".modal", m("header.modal-header", m("h2.text-primary strong is-center", event.title.toUpperCase())), m("section.modal-content ", m(".row", m(".col", m(".grouped", m(_clarity.CalendarLine, {
      fill: "#14854f"
    }), m(_DateTime["default"], {
      event: event
    })), event.location && m(".grouped", m(_clarity.HomeSolid, {
      fill: "#14854f",
      height: 60,
      width: 60
    }), m("label", event.location)), event.allDay && m(".grouped", m("label.tag.primary", "All Day Event"))), m(".col", m(".grouped clear icon", m(_clarity.UserLine, {
      fill: "#14854f"
    ...
    }, (0, _ramda.includes)(mdl.user.objectId, event.attendees) ? m("", m(_clarity.HappyFaceLine, {
      fill: "green"
    }), m("", "I'm Attending!")) : m("", m(_clarity.SadFaceLine), m("", "Not Attending"))), m(".button.clear icon-only", {
      onclick: function onclick() {
        return updateLikes(mdl, event);
      }
    }, m(_clarity.HeartLine, {
...
var CardOrd = function CardOrd() {
  ...
  return {
    view: function view(_ref2) {
      ...
      return m("article.card.col-6.bd-primary.p-x-50.p-y-6.bg-light.pointer", {
        id: id,
...
var Page3 = (0, _mithril["default"])(".", [(0, _mithril["default"])("h3", {
  style: {
    "text-align": "center",
    "white-space": "pre-wrap"
  }
}, (0, _mithril["default"])("strong", "# 1341013")), (0, _mithril["default"])("h3", {
  style: {
    "text-align": "center",
    "white-space": "pre-wrap"
  }
}, "Bonham Acres Subdivision Section 3 - Lugary"), (0, _mithril["default"])("p", {
  style: {
    "text-align": "center",
    "white-space": "pre-wrap"
  }
}, ["Volume 2853 Page 466 of the Records of Maps and Plats of Harris County, Texas", _mithril["default"].trust("&nbsp;")]), (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
}, "THE STATE OF TEXAS"), (0, _mithril["default"])("p", {
  style: {
    "text-align": "right",
    "margin-left": "40px",
    "white-space": "pre-wrap"
  }
}, "KNOW ALL MEN BY THESE PRESENTS:"), (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
}, "COUNTY OF HARRIS"), (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
...
}, ["That M. G. Rosenthal, being the owner of Bonham Acres ", (0, _mithril["default"])("strong", "Section 3,"), " a subdivision of 20.92 acres of land out of the ", (0, _mithril["default"])("em", "J. "), "R. Black Survey, Abstract 134, Harris County, Texas, according", _mithril["default"].trust("&nbsp;")]), (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
}, "to map of said subdivision, filed for record October 4, 1952, in the office of the County Clerk of Harris County, Texas, File No. 1323250 to which reference is here made for all purposes, does hereby declare that the lots and tracks in said subdivision shall from and after the date of this instrument be held and conveyed subject to the covenants, conditions, easements, restrictions and reservations hereinafter set out."), (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
}, ["M.G. Rosenthal does hereby dedicate the streets, drives, and lanes for use by the public as such reserving the right unto himself, his heirs, successors, and assigns to, at any time, use the same for the installation, maintenance, repairs, and renewal of any and all public utilities.", (0, _mithril["default"])("br")]), (0, _mithril["default"])("p", {
  style: {
    "text-align": "center",
    "white-space": "pre-wrap"
  }
...
}, (0, _mithril["default"])("strong", "DEFINITIONS"))), (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
}, "The word “street” as used herein shall include any street, drive. Boulevard, road, lane, avenue, or place as shown on the recorded plat as a thoroughfare."), (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
}, ["A “corner lot” is one that abuts on more than one street.", _mithril["default"].trust("&nbsp;"), " Any lot, except a corner, is deemed to front on the street upon which it abuts.", _mithril["default"].trust("&nbsp;"), " A corner lot shall be deemed to front on the street on which it has smallest frontage."]), (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
}), (0, _mithril["default"])("p", {
...
}, (0, _mithril["default"])("strong", "USE OF LAND"))), (0, _mithril["default"])("ol", {
  "data-rte-list": "default"
}, [(0, _mithril["default"])("li", (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
}, "No lots shall be used for anything other than residential purposes except Commercial Reserve Lots in Blocks 1 and 5, as shown by the Plat of Bonham Acres Section 3, which plots and areas have been set aside for community center and business purpose, such as retail stores, offices, shops, and utility facilities as may be hereinafter determined by M.G. Rosenthal, his heirs, successors, and assigns.")), (0, _mithril["default"])("li", (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
...
}, "No animals, livestock, or poultry of any kind shall be raised, bred, or kept on any lot, except that dogs, cats, or other household pets may be kept, provided that they are not kept, bred, or maintained for any commercial purposes.")), (0, _mithril["default"])("li", (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
}, "No noxious or offensive trade or activity shall be carried on o or upon any lot, nor shall anything be done thereon which may be, or become any annoyance or nuisance to the neighborhood.")), (0, _mithril["default"])("li", (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
}, "No spiritous, vinous, or malt or medicated bitters capable of producing intoxication shall ever be sold, or offered for sale on said premises, or any part thereof, except on commercial reserve lots in blocks 1 and 5, nor shall said premises, or any part thereof except on commercial reserve lots in blocks 1 and 5 be used for private or public professional purposes, nor shall any part thereof be used for illegal or immoral purposes."))]), (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
}), (0, _mithril["default"])("p", {
...
}, "All lots in the tract, except Commercial Reserve Lots block 1 and 5, shall be used for residential purposes."), (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
})]), (0, _mithril["default"])("li", [(0, _mithril["default"])("p", {
...
}, "No structure shall be erected on any residential plot other than one single family dwelling not to exceed two stories in height and one or two car garage."), (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
})]), (0, _mithril["default"])("li", [(0, _mithril["default"])("p", {
...
}, "No structure shall be moved onto any lot."), (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
})]), (0, _mithril["default"])("li", [(0, _mithril["default"])("p", {
...
}, "No garage apartment for rental purposes shall be permitted. However, this does not prevent occupancy of servants quarters by domestic servants domiciled with an owner occupant."), (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
})]), (0, _mithril["default"])("li", [(0, _mithril["default"])("p", {
...
}, "All improvements shall be constructed on the lot so as to front on the street upon which such lot faces."), (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
})]), (0, _mithril["default"])("li", [(0, _mithril["default"])("p", {
...
}, "Dwelling on corner lots shall have a presentable frontage on all streets which that particular lot fronts."), (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
})]), (0, _mithril["default"])("li", [(0, _mithril["default"])("p", {
...
}, "No residence shall be constructed on any lot or building or building lot in this addition with less than one thousand (1,000) square feet of ground floor area exclusive of porches and garage."), (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
})]), (0, _mithril["default"])("li", [(0, _mithril["default"])("p", {
...
}, "No fence , wall, hedge, pergola, or other detached structures for ornamental purposes shall be erected, grown, or maintained on any part of any lot forward of the front building of said lot without a written consent of the Architectural Committee."), (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
})]), (0, _mithril["default"])("li", [(0, _mithril["default"])("p", {
...
}, "No radio aerial wires shall be maintained on any portion of ant lot forward of the front building line of said lot."), (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
})]), (0, _mithril["default"])("li", [(0, _mithril["default"])("p", {
...
}, "No building of frame construction on the exterior of any kind or character shall be erected on any lot unless same, at the time of construction, shall receive at least two coats of paint."), (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
})]), (0, _mithril["default"])("li", [(0, _mithril["default"])("p", {
...
}, "No stumps, tree, underbrush, or any refuse of any kind, or scrap material from the improvements being erected on any lot, shall be placed on any adjoining lots, streets, or easements. All such material, if not disposed of immediately, must remain on the property on which construction work is in progress and at the completion of such improvements such material must be immediately removed from the property."), (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
})]), (0, _mithril["default"])("li", [(0, _mithril["default"])("p", {
...
}, ["The Architectural Committee shall be composed of Harold Hill, Ray Wilson, and Dr. Russell Bonham, all of Harris County, Texas.", _mithril["default"].trust("&nbsp;"), " This Committee and its successors are hereby vested with the full right and authority to act as such under the provisions of these restrictions. The majority of such committee shall have the right to designate a representative to act for it in all matters arising hereunder.", _mithril["default"].trust("&nbsp;"), " In the event of the death or resignation of any member of the Committee, the remaining members shall have full right and authority to act herein and to designate a representative to assist."]), (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
}), (0, _mithril["default"])("p", {
...
}, "Neither the members of such Committee, nor any designated representatives, shall be entitled to any compensation for services preformed pursuant to these restrictions."), (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
}), (0, _mithril["default"])("p", {
...
}, ["At any time a vacancy exists on said committee M.G. Rosenthal shall have the right to fill vacancies and should he fail to do so within 30 days after receiving notice of such vacancy the remaining members of the committee shall have the right to fill any vacancy.", _mithril["default"].trust("&nbsp;"), " All appointments and designations of persons as successors to the Committee shall be made in writing by a recordable instrument, which shall be filed for record in Harris County Texas.", _mithril["default"].trust("&nbsp;"), " The powers and duties of the Committee, as from time to time constituted, shall continue in force during the effective period of the restrictions hereby created."]), (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
}), (0, _mithril["default"])("p", {
...
}, ["Thereafter, the owners of fifty one percent (51%) of the lots in Bonham Acres Section 3 (one lot or home site constituting one ownership) becoming dissatisfied with any members as then constituted, shall have the right to remove any member or members of said committee, and may designate and appoint a new member or members by written petition bearing, the signatures of the property owners so acting.", _mithril["default"].trust("&nbsp;"), " The petition shall show the property owned by each petitioner.", _mithril["default"].trust("&nbsp;"), " In case property is owned by man and wife as community property, the signature of the husband alone shall be sufficient, except that in cases where the husband resides elsewhere, or has abandoned his wife, her signature shall be sufficient alone.", (0, _mithril["default"])("br")]), (0, _mithril["default"])("p", {
  style: {
    "text-align": "center",
    "white-space": "pre-wrap"
  }
...
}, (0, _mithril["default"])("strong", "DURATION OF RESTRICTIONS"))), (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
}, (0, _mithril["default"])("br")), (0, _mithril["default"])("p", {
  style: {
    "text-align": "center",
    "white-space": "pre-wrap"
  }
...
}, (0, _mithril["default"])("strong", "RIGHT TO ENFORCE"))), (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
}), (0, _mithril["default"])("p", {
...
}, (0, _mithril["default"])("strong", "EASEMENTS"))), (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
}), (0, _mithril["default"])("p", {
...
}, "EXECUTED at Houston, Texas, as of the 1st of September, A, D. 1954."), (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
}), (0, _mithril["default"])("p", {
...
}, "ATTEST:"), (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
}, "___________________"), (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
}, ["*W Goldston - Cashier", (0, _mithril["default"])("br"), (0, _mithril["default"])("em", "*The signatures and the Seal of University State Bank appear on original and filed copy"), (0, _mithril["default"])("br")]), (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
}, "THE STATE OF TEXAS"), (0, _mithril["default"])("p", {
...
}, ["BEFORE ME, the undersigned authority, a Notary Public in and for said County and State, on this day personally appeared, M. G. Rosenthal known to me to be the person whose name is subscribed to the fore going instrument, and acknowledge to me that he executed the same for the purpose and consideration therein expressed.", _mithril["default"].trust("&nbsp;")]), (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
}), (0, _mithril["default"])("p", {
...
}, "GIVEN under my hand and seal of office, this 26th day of October, A.D., 1954."), (0, _mithril["default"])("p", {
  style: {
    "text-align": "right",
    "white-space": "pre-wrap"
  }
}, "___________________________________"), (0, _mithril["default"])("p", {
  style: {
    "text-align": "right",
    "white-space": "pre-wrap"
  }
}, "*Elaine L. Oates"), (0, _mithril["default"])("p", {
  style: {
    "text-align": "right",
    "white-space": "pre-wrap"
  }
}, "Notary Public in and for Harris County Texas"), (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
}, (0, _mithril["default"])("em", "*Elaine L. Oates’ signature and Seal appear on original and filed copy"))]);
var Page2 = (0, _mithril["default"])(".", [(0, _mithril["default"])("h3", {
  style: {
    "text-align": "center",
    "white-space": "pre-wrap"
  }
}, (0, _mithril["default"])("strong", "# 1052372")), (0, _mithril["default"])("h3", {
  style: {
    "text-align": "center",
    "white-space": "pre-wrap"
  }
}, [_mithril["default"].trust("&nbsp;"), "Bonham Acres Subdivision Section 2 - CADAWAC Rd"]), (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
}, "THE STATE OF TEXAS"), (0, _mithril["default"])("p", {
...
}, ["That we, Dr. Russell F. Bonham and wife Dora Bonham; the owners of Bonham Acres ", (0, _mithril["default"])("strong", "Second Section,"), " a Sub-division out of the ", (0, _mithril["default"])("em", "J. "), "R. Black Survey, Abstract 134, Harris County, Texas, a plat of which was filed with the County Clerk of Harris County, Texas, on September 5, 1952, under File No. 1037211, and which instrument is of record. ", (0, _mithril["default"])("em", "in "), "Volume ____", (0, _mithril["default"])("span", {
  style: {
    "text-decoration": "underline"
  }
}, (0, _mithril["default"])("strong", (0, _mithril["default"])("em", ","))), (0, _mithril["default"])("strong", (0, _mithril["default"])("em")), "Page ____of the Records of Maps and Plats of Harris County, Texas, do hereby establish the following minimum restrictions and covenants upon the use ", (0, _mithril["default"])("strong", ["of Lots A ", _mithril["default"].trust("&amp;"), " B ", _mithril["default"].trust("&amp;"), " lots 1 to 32,"]), " inclusive, in said Addition, and hereby declare that all conveyances of said lots or tracts in said Addition shall be subject to the following minimum restrictions, covenants, easements and conditions, which shall be, continue and remain in effect until January 1, 1972, at which time, said covenants and restrictions shall be automatically extended for successive periods of ten years unless by a vote of the majority of the then owners of the lots in said Addition, it is agreed to change the said covenants or restrictions it whole or in part. Such vote shall be evidenced by written declaration, signed and acknowledged by such owners wad recorded in the Deed Records of ", (0, _mithril["default"])("em", "Harris "), "County, Texas.", (0, _mithril["default"])("br")]), (0, _mithril["default"])("ol", {
  "data-rte-list": "default"
}, [(0, _mithril["default"])("li", [(0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
}, "No business or professional house, sanitarium, hospital, saloon, place of public amusement or entertainment, livery stable, factory, warehouse, duplex, apartment house, rooming house, boarding house, or place of business of any kind, shall be constructed, built, kept or maintained on the said lots, nor shall any house on said premises be used for any such purpose or purposes, but said premises shall be used for one family residence only. No trailer, tent, or other outbuilding placed or erected on said lots shall at any tine be used as a residence, either temporarily or permanently, nor shall any structure of a temporary character be used as a residence."), (0, _mithril["default"])("p", {
...
}, "Only one residence may be contracted on any lot or lot and a fractional part of a lot"), (0, _mithril["default"])("p", {
  "data-rte-preserve-empty": "true",
  style: {
    "white-space": "pre-wrap"
  }
...
}, ["No servant quarters shall be occupied as a residence, either before or during the erection of ", (0, _mithril["default"])("strong", (0, _mithril["default"])("em", "the ")), "main residence building, snit after the erection of such main residence building, such servant quarters shall be occupied only ", (0, _mithril["default"])("strong", (0, _mithril["default"])("em", "by ")), "domestic servants."]), (0, _mithril["default"])("p", {
  "data-rte-preserve-empty": "true",
  style: {
    "white-space": "pre-wrap"
  }
...
}, "No spirituous, vinous or malt liquors, or medicated bitters capable of producing intoxication shall ever be sold or offered for sale on any of said lots"), (0, _mithril["default"])("p", {
  "data-rte-preserve-empty": "true",
  style: {
    "white-space": "pre-wrap"
  }
...
}, ["No trash, ashes or other refuse may be thrown ", (0, _mithril["default"])("em", "on "), (0, _mithril["default"])("strong", (0, _mithril["default"])("em", "any vacant ")), "lot, avenue, boulevard, drive or street."]), (0, _mithril["default"])("p", {
  "data-rte-preserve-empty": "true",
  style: {
    "white-space": "pre-wrap"
  }
...
}, ["No nuisance or advertising sign, billboard or other advertising device shall be placed on or suffered to ", (0, _mithril["default"])("strong", (0, _mithril["default"])("em", "remain ")), "upon any of said lots, except that the developers may place thereon such advertising signs or devices as they may deem appropriate, helping to do with ", (0, _mithril["default"])("strong", (0, _mithril["default"])("em", "the ")), "sale ", (0, _mithril["default"])("strong", (0, _mithril["default"])("em", "of the ")), "property, and except that any lot owner may place a lot owned by him for re-sale, a sign so indicating having an area of not more than five square feet and a height of not more than four feet from the surface of the ground."]), (0, _mithril["default"])("p", {
  "data-rte-preserve-empty": "true",
  style: {
    "white-space": "pre-wrap"
  }
...
}, "No livestock of any kind shall be kept or harbored on said premises."), (0, _mithril["default"])("p", {
  "data-rte-preserve-empty": "true",
  style: {
    "white-space": "pre-wrap"
  }
...
}, ["It is understood and agreed that ", (0, _mithril["default"])("em", "the "), "easements shown on said plat and those referred to in this and the section immediately preceding are to be reserved as perpetual easements for the purposes indicated."]), (0, _mithril["default"])("p", {
  "data-rte-preserve-empty": "true",
  style: {
    "white-space": "pre-wrap"
  }
...
}, "No drilling, developing, or exploring for oil, gas, sulfur or other minerals shall ever be permitted on any of said lots."), (0, _mithril["default"])("p", {
  "data-rte-preserve-empty": "true",
  style: {
    "white-space": "pre-wrap"
  }
...
}, ["The type and minimum cost of any residence which may be erected or constructed on said lots ", (0, _mithril["default"])("em", "stall "), "be an follows;"]), (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
}, "No residence shall be erected on any tract that contains less than 1,150 square feet of floor space, exclusive Of the garage and servant's quarters, porches or breezeways."), (0, _mithril["default"])("p", {
  "data-rte-preserve-empty": "true",
  style: {
    "white-space": "pre-wrap"
  }
...
}, "All residences shall be constructed of brick, brick veneer, concrete and stucco, hollow tile, rock, rock veneer, frame, or some other form of building material, but no residence or residences shall be constructed of materials unacceptable to the said individuals for approval of design."), (0, _mithril["default"])("p", {
  "data-rte-preserve-empty": "true",
  style: {
    "white-space": "pre-wrap"
  }
...
}, "EXECUTED this the 14th of October, A, D. 1952."), (0, _mithril["default"])("p", {
  style: {
    "text-align": "right",
    "white-space": "pre-wrap"
  }
}, "____________________________"), (0, _mithril["default"])("p", {
  style: {
    "text-align": "right",
    "white-space": "pre-wrap"
  }
}, "*Dr. Russell F. Bonham"), (0, _mithril["default"])("p", {
  style: {
    "text-align": "right",
    "white-space": "pre-wrap"
  }
...
}, "*Dora Bonham"), (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
}, [(0, _mithril["default"])("em", "*Original Recorded Copies were signed"), (0, _mithril["default"])("br")]), (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
}, "THE STATE OF TEXAS"), (0, _mithril["default"])("p", {
...
}, "W.H. COLBERT"), (0, _mithril["default"])("p", {
  style: {
    "text-align": "right",
    "white-space": "pre-wrap"
  }
...
}, [(0, _mithril["default"])("em", "W.H. COLBERT signature and Seal appear on original and filed copy"), (0, _mithril["default"])("br"), (0, _mithril["default"])("em", "Filed for Record "), (0, _mithril["default"])("span", {
  style: {
    "text-decoration": "underline"
  }
}, (0, _mithril["default"])("strong", (0, _mithril["default"])("em", "Oct 16, 1952, "))), (0, _mithril["default"])("strong", (0, _mithril["default"])("em", "at 1:00 o’clock PM"))])]);
var Page1 = (0, _mithril["default"])(".", [(0, _mithril["default"])("h3", {
  style: {
    "text-align": "center",
    "white-space": "pre-wrap"
  }
}, (0, _mithril["default"])("strong", "# 521224 ")), (0, _mithril["default"])("h3", {
  style: {
    "text-align": "center",
    "white-space": "pre-wrap"
  }
}, "Bonham Acres Subdivision Section 1 - Bonhomme Rd"), (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
}, "THE STATE OF TEXAS"), (0, _mithril["default"])("p", {
...
}, ["That we, Dr. Russell F. Bonham and wife Dora Bonham; the owners of Bonham Acres,a Sub-division out of the ", (0, _mithril["default"])("em", "J. "), "R. Black Surveys, a plat of which is recorded. ", (0, _mithril["default"])("em", "in "), "Volume 24", (0, _mithril["default"])("span", {
  style: {
    "text-decoration": "underline"
  }
}, (0, _mithril["default"])("strong", (0, _mithril["default"])("em", ","))), (0, _mithril["default"])("strong", (0, _mithril["default"])("em")), "Page 26 of the Records of Maps and Plats of Harris County, Texas, and joined herein by Richard I Anderson and wife Doris Anderson", (0, _mithril["default"])("strong", [", do hereby establish the following minimum restrictions and covenants upon the use", _mithril["default"].trust("&nbsp;"), " of lots Nos. 2 to 20 "]), "inclusive, in said Addition, and hereby declare that all conveyances of said lots or tracts in said Addition shall be subject to the following minimum restrictions, covenants, easements and conditions, which shall be, continue and remain in effect until January 1, 1970, at which time, said covenants and restrictions shall be automatically extended for successive periods of ten years unless by a vote of the majority of the then owners of the lots in said Addition, it is agreed to change the said covenants or restrictions it whole or in part. Such vote shall be evidenced by written declaration, signed and acknowledged by such owners wad recorded in the Deed Records of ", (0, _mithril["default"])("em", "Harris "), "County, Texas."]), (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
}, (0, _mithril["default"])("br")), (0, _mithril["default"])("ol", {
  "data-rte-list": "default"
}, [(0, _mithril["default"])("li", [(0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
...
}, (0, _mithril["default"])("br"))]), (0, _mithril["default"])("li", [(0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
...
}, "No residence shall be erected on any tract that contains less than 1,500 square feet of floor space, exclusive of the garage and servant's quarters, porches or breezeways."), (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
}, (0, _mithril["default"])("br"))]), (0, _mithril["default"])("li", (0, _mithril["default"])("p", {
...
}, [(0, _mithril["default"])("br"), "It is understood and agreed that the foregoing restrictions, easements, covenants and conditions shall be ", (0, _mithril["default"])("em", "deemed. "), "to be covenants running with the land and shall be binding upon all grantees who may purchase any of said lots in said Addition; their ", (0, _mithril["default"])("em", "heirs "), "or assigns, ", (0, _mithril["default"])("em", "or any "), "other person claiming under them; and should they, or any of them at any time violate, or attempt to violate, or shall omit to perform or observe any of the foregoing restrictions or conditions, it shall be lawful for any person owning land, which is subject to the same restrictions or conditions in respect to which default is made, or for the said owners, their heirs, representatives, successors and assigns, to institute and prosecute appropriate proceedings at law or in equity for the wrong done or attempted", (0, _mithril["default"])("br"), (0, _mithril["default"])("br")]), (0, _mithril["default"])("p", {
  style: {
    "text-align": "center",
    "white-space": "pre-wrap"
  }
}, "EXECUTED this the 19th of April, A, D. 1948."), (0, _mithril["default"])("p", {
  style: {
    "text-align": "right",
    "white-space": "pre-wrap"
  }
...
}, (0, _mithril["default"])("em", "*Original Recorded Copies were signed")), (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
}, "THE STATE OF TEXAS"), (0, _mithril["default"])("p", {
...
}, [(0, _mithril["default"])("br"), "BEFORE ME, the undersigned authority, on this day personally appeared, DR. RUSSELL F. BONHAM and wife DORA BONHAM, known to me to be the persons whose names are subscribed to the foregoing instrument, and acknowledged to me that they executed the same for the purpose and considerations therein expressed; and the said DORA BONHAM, wife of the said DR. RUSSELL F. BONHAM, having been examined by me privately and apart from her husband , and having the same fully explained to her, she, the said DORA BONHAM, acknowledged said instrument to be her act and deed and declared that she had willingly signed the same for the purpose and consideration therein expressed, and that she did not wish to retract it."]), (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
}, (0, _mithril["default"])("br")), (0, _mithril["default"])("p", {
...
}, "GIVEN UNDER MY HAND AND SEAL OF OFFICE this the 19th day of April, A.D., 1948."), (0, _mithril["default"])("p", {
  style: {
    "text-align": "right",
    "white-space": "pre-wrap"
  }
...
}, ["Notary Public in and for Harris County Texas", (0, _mithril["default"])("br"), (0, _mithril["default"])("br")]), (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
}, ["THE STATE OF TEXAS", (0, _mithril["default"])("br"), "COUNTY OF HARRIS"]), (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
...
}, (0, _mithril["default"])("em", "W.H. COLBERT signature and Seal appear on original and filed copy")), (0, _mithril["default"])("p", {
  style: {
    "white-space": "pre-wrap"
  }
}, [(0, _mithril["default"])("em", "Filed for Record "), (0, _mithril["default"])("span", {
  style: {
    "text-decoration": "underline"
  }
}, [(0, _mithril["default"])("em", "April 21, 1952, at 3:00 o’clock PM")])])]);
var pages = [Page1, Page2, Page3];

var DeedRes = function DeedRes(mdl) {
  var state = {
    page: 0
  };
  return {
    view: function view(_ref) {
      var mdl = _ref.attrs.mdl;
      return (0, _mithril["default"])(".container", (0, _mithril["default"])(".", (0, _mithril["default"])("button.button.icon", {
        disabled: state.page == 0,
        onclick: function onclick(e) {
          return state.page--;
        }
      }, "Prev"), (0, _mithril["default"])("button.button.icon", {
        disabled: !(state.page < pages.length - 1),
        onclick: function onclick(e) {
          return state.page++;
        }
      }, "Next")), (0, _mithril["default"])(".container", {
        style: {
          height: "100vh",
          overflow: "scroll"
        }
...
var createCarousel = function createCarousel(dom) {
  ...
  slider.events.on("touch", function (e) {
    return console.log("index", slider.getInfo(), e.displayIndex, e.container.children, e.container.children.length);
  });
  State[dom.id] = slider;
};
...
var Home = function Home() {
  return {
    ...
    view: function view(_ref3) {
      var mdl = _ref3.attrs.mdl;
      return m("article.grid", m("section.row.p-b-25.bg-light", mdl.data.events.any() && m(".container", m("h2.is-center", "Upcoming Events!"), m(".grouped.#events", SliderController(mdl), mdl.data.events.map(function (event, idx) {
        ...
        }, event.allDay && m(".tag", "All Day Event!"), m("h4.text-primary", event.title), m("img", {
          src: event.image
        }), m(_DateTime["default"], {
          event: event
        }) // m(
      ...
      })))), m("section.row.p-b-25.bg-primary.text-white", mdl.data.images.any() && m(".container", m("h2.is-center", "Recent Photos"), m(".grouped.#images", SliderController(mdl), mdl.data.images.map(function (img, idx) {
        return m("img.card.auto", {
          key: idx,
          src: img.thumb,
          style: {}
        });
      })))), m("section.row.p-b-25.bg-light", mdl.data.blogs.any() && m(".container", m("h2.is-center", "Recent Blogs"), m(".grouped.#blogs", SliderController(mdl), mdl.data.blogs.map(function (blog, idx) {
        return m(".card.opacity-overlay.is-vertical-align row", {
          key: idx
        }, m("figure", m("img", {

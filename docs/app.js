...
var Hamburger = function Hamburger() {
  return {
    view: function view(_ref) {
      ...
      return mdl.state.isAuth() ? m("span", [m("span", "Welcome ".concat(mdl.user.name.split(" ")[0])), m(".icon-click.", mdl.state.showNavModal() ? m(_clarity.WindowCloseLine) : m(_clarity.BarsLine))]) : m(".icon-click.", mdl.state.showNavModal() ? m(_clarity.WindowCloseLine) : m(_clarity.BarsLine));
    }
  };
};
...
var AuthBox = function AuthBox() {
  return {
    view: function view(_ref) {
      ...
      })] : m(".grid", [m(_navLink["default"], {
        mdl: mdl,
        href: "/login",
        link: "Login",
        classList: "col ".concat((0, _index.isActiveRoute)("/login"), " button auth-link")
      }), m(_navLink["default"], {
        mdl: mdl,
        href: "/register",
        link: "Register",
        classList: "col ".concat((0, _index.isActiveRoute)("/register"), " button auth-link")
      })]);
    }
  };
};
...
var NavSection = function NavSection(_ref2) {
  ...
  return {
    view: function view(_ref3) {
      ...
      return m(".nav-section", {
        onclick: function onclick(e) {
          return toggleRoutes(mdl)(route.id);
        }
      }, m(".grid", m(".col-9", route.name), m(".col-3", m(_clarity.AngleLine, {
        style: {
        ...
        return r.group.includes("external") ? m("li.nav-link", m("a", {
          ...
          href: r.route,
          link: r.name,
          classList: "p-8 grid-between ".concat((0, _index.isActiveRoute)(r.route))
        });
      }))));
    }
  };
    ...
    view: function view(_ref5) {
      ...
      return m(".modalOverlay-left.animated", {
        ...
        return r.children.any() ? m(NavSection, {
          ...
          href: r.route,
          link: r.name,
          classList: ".col ".concat((0, _index.isActiveRoute)(r.route))
        }));
      })])));
    }
  };
...
var Navbar = function Navbar() {
  ...
  return {
    view: function view(_ref) {
      var mdl = _ref.attrs.mdl;
      return m("nav#navigation", [m("nav.grid.col.col-12.navbar", routes(mdl).map(function (r) {
      ...
      })), subroutes(mdl).any() && m("nav.grid.col.col-12", {
        id: "sub-navbar"
...
var Toolbar = function Toolbar() {
  return {
    view: function view(_ref) {
      var mdl = _ref.attrs.mdl;
      return m(".toolbar.grid", m(".col", m("img.nav-logo", {
        src: "Images/logo.webp"
      })), mdl.settings.screenSize == "desktop" ? m(".col", m(_authbox["default"], {
        mdl: mdl
      })) : m(".grid.grid-end", {
        style: {
          position: "absolute",
...
m.route(root, "/about-BonHamAcres", (0, _app["default"])(_index["default"]));
});

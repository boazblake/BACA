...
var LegalRoutes = [{
  ...
  options: [],
  onmatch: function onmatch(mdl, args, path, fullroute, isAnchor) {
    return isAnchor ? (0, _index2.scrollToAnchor)(mdl.state.anchor) : (0, _index2.PageTitle)().scrollIntoView({
      behavior: "smooth",
      block: "center",
      inline: "start"
    });
...
var MemberRoutes = [{
  ...
  options: [],
  onmatch: function onmatch(mdl, args, path, fullroute, isAnchor) {
    return isAnchor ? (0, _Utils.scrollToAnchor)(mdl.state.anchor) : (0, _Utils.PageTitle)().scrollIntoView({
      behavior: "smooth",
      block: "center",
      inline: "start"
    });

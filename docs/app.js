...
var createCarousel = function createCarousel(dom) {
  ...
  var prev = dom.children[2];
  var next = dom.children[3];
...
var Home = function Home() {
  return {
    ...
    view: function view(_ref3) {
      var mdl = _ref3.attrs.mdl;
      return m("article.grid", m("section.row.p-b-25.bg-light", mdl.data.events.any() && m(".container.glider-contain", SliderController(mdl), m("h2.is-center", "Upcoming Events!"), m(".grouped.#events.glider", {
        style: {
          maxHeight: "60vh"
        }
      }, mdl.data.events.map(function (event, idx) {
      ...
      })), m("button.button.outline.dark", "PREV"), m("button.button.outline.dark", "NEXT"))), m("section.row.p-b-25.bg-primary.text-white", mdl.data.images.any() && m(".container.glider-contain", SliderController(mdl), m("h2.is-center", "Recent Photos"), m(".grouped.#images.glider", {
        style: {
          maxHeight: "60vh"
        }
      }, mdl.data.images.map(function (img, idx) {
      ...
      })), m("button.button.outline", "PREV"), m("button.button.outline", "NEXT"))), m("section.row.p-b-25.bg-light", mdl.data.blogs.any() && m(".container.glider-contain", SliderController(mdl), m("h2.is-center", "Recent Blogs"), m(".grouped.#blogs.glider", {
        style: {
          maxHeight: "60vh"
        }
      }, mdl.data.blogs.map(function (blog, idx) {
      ...
      })), m("button.button.outline.dark", "PREV"), m("button.button.outline.dark", "NEXT"))));
    }
  };
};
